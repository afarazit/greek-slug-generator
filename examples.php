...
echo GreekSlugGenerator::slugify('As well as brackets {[()]}, quotes `\'", commas, and full stops.', '_') . "\n";
...
echo GreekSlugGenerator::slugify('Some others are converted in dashes, but if at any point multiple sequential dashes are produced, only one appears: \/_-', '_') . "\n";
...
echo GreekSlugGenerator::slugify('Greek example #1: Έκθεση Φωτογραφίας «Το Ρέθυμνο και η Θάλασσα» - "Ημέρες Ρεθύμνου" 2013','_'). "\n";
